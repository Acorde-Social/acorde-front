...
export function FinalCTA() {
  ...
  return (
    <div className="relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#f9fafb] via-white to-[#f9fafb] dark:from-[#050507] dark:via-[#120a1a] dark:to-[#050507]">
        <div className="absolute inset-0 opacity-[0.03]">
          <svg className="w-full h-full" preserveAspectRatio="none" viewBox="0 0 1200 400">
            ...
            <rect width="100%" height="100%" fill="url(#cta-pattern)" className="dark:opacity-60" />
          </svg>
        </div>
        ...
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#fcd34d] to-transparent dark:via-[#8b5cf6]" />
        <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#2c1e4a] to-transparent dark:via-[#6d28d9]" />
      </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-4xl text-center">
              <div className="inline-flex items-center gap-2 mb-6 sm:mb-8">
                ...
                <span className="text-sm font-semibold text-[#2c1e4a] bg-gradient-to-r from-[#fcd34d]/10 to-[#2c1e4a]/10 px-4 py-1.5 rounded-full border border-[#fcd34d]/20 dark:text-[#fcd34d] dark:bg-[#111827]/70 dark:border-[#fcd34d]/35">
                  Última Etapa
                </span>
              </div>

              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-4 sm:mb-6">
                <span className="bg-gradient-to-r from-[#2c1e4a] via-[#374151] to-[#2c1e4a] bg-clip-text text-transparent dark:from-[#fcd34d] dark:via-[#f3f4f6] dark:to-[#fcd34d]">
                  Sua Jornada Musical{' '}
                </span>
              ...
              <p className="text-sm sm:text-lg md:text-xl text-[#374151] max-w-2xl mx-auto mb-8 sm:mb-10 dark:text-[#e5e7eb]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-10 md:mb-12 max-w-3xl mx-auto">
                {stats.map((stat, index) => {
                  const Icon = stat.icon;
                  return (
                    <div key={index} className="text-center">
                      <div className="flex items-center justify-center gap-2 mb-2">
                        <div className="p-2 rounded-lg bg-gradient-to-br from-white to-[#f9fafb] border border-[#374151]/10 dark:from-[#111827] dark:to-[#0f172a] dark:border-[#fcd34d]/20">
                          <Icon className="h-4 w-4 text-[#2c1e4a]" />
                        </div>
                        <div className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-[#2c1e4a] to-[#374151] bg-clip-text text-transparent dark:from-[#fcd34d] dark:to-[#f3f4f6]">
                          {stat.value}
                        </div>
                      </div>
                      <div className="text-xs sm:text-sm text-[#374151] font-medium dark:text-[#d1d5db]">
                        {stat.label}
                      </div>
                    </div>
                  );
              ...
              <div className="mb-8 sm:mb-10 md:mb-12">
                <Button
                  asChild
                  size="lg"
                  className={`group relative px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-7 text-sm sm:text-base md:text-lg font-semibold rounded-2xl overflow-hidden transition-all duration-500
              ...
              <div className="max-w-md mx-auto">
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 text-xs sm:text-sm text-[#374151] dark:text-[#d1d5db]">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                    <span className="font-medium">Sem compromisso</span>
                  </div>
                  <div className="hidden sm:block w-4 h-px bg-[#374151]/20 dark:bg-[#fcd34d]/25" />
                  <div className="flex items-center gap-2">
                ...
                <div className="mt-8 pt-6 border-t border-[#374151]/10 dark:border-[#fcd34d]/15">
                  <p className="text-sm text-[#374151]/60 italic dark:text-[#9ca3af]">
