		...
		<div ref={searchRef} className="relative">
			...
			{!isOpen && (
				<Button
					...
					size="icon"
					onClick={handleOpen}
					className="h-8 w-8 sm:h-10 sm:w-10 hover:bg-primary/5"
				>
			...
			{isOpen && (
				<>
					...
					<div className={cn(
						...
						{/* Input container */}
						<div className="relative bg-background border border-border rounded-lg shadow-lg md:shadow-xl overflow-hidden">
