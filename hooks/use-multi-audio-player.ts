...
import type { FeedItem } from '@/app/(app)/home/data/mock-feed-data'
...
export function useMultiAudioPlayer() {
  ...
  const handlePlayPause = useCallback((item: FeedItem) => {
  ...
  const handleSeek = useCallback((item: FeedItem, percentage: number) => {
