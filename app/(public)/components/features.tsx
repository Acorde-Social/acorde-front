    ...
    const features: Feature[] = [
        {
            ...
            description: 'Encontre colaboradores perfeitos baseado em estilo, habilidades e disponibilidade.',
        ...
        <div className="relative overflow-hidden">
            <div className="absolute inset-0">
                ...
                <video
                    ...
                    <source src="https://pub-9e416a3ef36044a5aab78f234be56e68.r2.dev/dev/landing-page/videos/landingpage-bg-features-video1.mp4" type="video/mp4" />
                </video>
                ...
                <section className="py-20 md:py-28">
                    <div className="container px-4 md:px-6">
                        ...
                        <div className="mx-auto max-w-5xl text-center mb-16">
                            ...
                            <p className="text-xl text-[#374151] max-w-3xl mx-auto mb-6">
                        ...
                        <div className="flex flex-wrap justify-center gap-4 mb-12">
                            {categories.map((category) => (
                                <button
                                    key={category.id}
                                    className="px-6 py-3 rounded-full bg-gradient-to-r from-white to-[#f9fafb] text-[#374151] border border-[#374151]/15 hover:border-[#fcd34d]/40 hover:text-[#2c1e4a] transition-all duration-300 font-medium shadow-sm hover:shadow-md"
                                >
                                    {category.label}
                                    <span className="ml-2 text-sm bg-gradient-to-r from-[#fcd34d]/10 to-[#2c1e4a]/10 text-[#2c1e4a] px-2 py-0.5 rounded-full">
                                        {category.count}
                                    </span>
                                </button>
                            ))}
                                    ...
                                    <Card className="relative bg-white/95 backdrop-blur-sm border border-[#374151]/10 group-hover:border-[#fcd34d]/40 h-full shadow-lg group-hover:shadow-2xl transition-all duration-500 group-hover:-translate-y-1">
                                        ...
                                        <CardContent className="p-6 h-full flex flex-col">
                                            ...
                                            <div className="flex items-start justify-between mb-4">
                                                ...
                                                <Badge className="bg-gradient-to-r from-[#f9fafb] to-white text-[#374151] border border-[#374151]/15 px-3 py-1 rounded-full text-xs font-medium">
                                                    {feature.category}
                                                </Badge>
                                            </div>

                                            <div className="mb-5">
                                                <h3 className="font-bold text-lg text-[#111827] mb-2 group-hover:text-[#2c1e4a] transition-colors duration-300">
                                                    {feature.title}
                                                </h3>
                        ...
                        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                            {[
                                ...
                                <div key={index} className="text-center">
                                    <div className="text-4xl font-bold bg-gradient-to-r from-[#2c1e4a] to-[#374151] bg-clip-text text-transparent mb-2">
                                        {stat.value}
                                    </div>
