  ...
  return (
    <div className="container max-w-3xl py-12">
      ...
      <div className="prose dark:prose-invert">
        ...
        <p>
          Bem-vindo ao Acorde. Estes Termos de Serviço regem seu uso da plataforma Acorde, incluindo todos os recursos, funcionalidades, aplicativos, e serviços associados.
          Ao acessar ou usar o Acorde, você concorda em cumprir estes Termos de Serviço. Se você não concordar com qualquer parte destes termos, não poderá acessar ou usar a plataforma.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">2. Definições</h2>
        <p>
          <strong>"Plataforma"</strong> refere-se ao website, aplicativos, e serviços Acorde.<br />
        ...
        <p>
          ...
          A Acorde reserva-se o direito de suspender ou encerrar contas que violem estes Termos.
        </p>
        ...
        <p>
          ...
          No entanto, você concede à Acorde uma licença mundial, não exclusiva, livre de royalties para uso, reprodução, modificação, adaptação, publicação, tradução, e distribuição desse Conteúdo na Plataforma e em materiais promocionais relacionados.
        ...
        <p>
          ...
          Os termos específicos de cada colaboração devem ser acordados entre os colaboradores e a Acorde não se responsabiliza por disputas relacionadas a colaborações.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">7. Modificações</h2>
        <p>
          A Acorde se reserva o direito de modificar estes Termos a qualquer momento. Alterações significativas serão notificadas aos usuários através da Plataforma ou por email.
        ...
        <p>
          Estes Termos constituem o acordo completo entre você e a Acorde e substituem todos os acordos anteriores.
